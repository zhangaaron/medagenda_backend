...
patients = [Patient.create(lastname: 'Paulos', dob: Time.new('1969-04-01'), room:'160'),
            Patient.create(lastname: 'Dirks', dob: Time.new('1994-11-27'), room: '107'),
            Patient.create(lastname: 'Hu', dob: Time.new('1991-11-11'), room: '69'),
            Patient.create(lastname: 'Tan', dob: Time.new('1999-10-31'), room: '420')]
task_deets = ['Check temperature', 'Administer suppository', 'tell bedtime story',
              'give a strong high five']
